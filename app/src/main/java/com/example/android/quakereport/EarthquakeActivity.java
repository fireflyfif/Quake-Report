...
public class EarthquakeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(LOG_TAG, "What happens when initLoader is called?");
    ...
    public Loader<List<Earthquake>> onCreateLoader(int i, Bundle args) {
        ...
        Log.e(LOG_TAG, "What is the new URL " + uriBuilder);
    ...
    public void onLoadFinished(Loader<List<Earthquake>> loader, List<Earthquake> earthquakes) {
        ...
        Log.e(LOG_TAG, "When is onLoadFinished method called?");
        ...
        if (earthquakes != null && !earthquakes.isEmpty()) {
            Log.e(LOG_TAG, "When the earthquakes are not null?");
    ...
    public void onLoaderReset(Loader<List<Earthquake>> loader) {
        Log.e(LOG_TAG, "When is onLoaderReset method called?");
