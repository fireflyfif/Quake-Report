...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            // Extract “features” JSONArray associated with the key called "features"
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                // Extract "URL" for the current earthquake
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (inputStream != null) {
                ...
                // the makeHttpRequest (URL url) method signiture specifies than an IOException
                // could be thrown.
                inputStream.close();
            }
        }
